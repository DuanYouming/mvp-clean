...
public class DeleteLabelDetail extends UseCase<DeleteLabelDetail.RequestValue, DeleteLabelDetail.ResponseValue> {
    private static final String TAG = DeleteLabelDetail.class.getSimpleName();
    private LabelDetailRepository mRepository;

    DeleteLabelDetail(LabelDetailRepository repository) {
    ...
    protected void executeUseCase(RequestValue requestValues) {
        ...
        mRepository.deleteLabelDetail(requestValues.getBody(), callback);
