...
import com.foxconn.bandon.zixing.camera.open.OpenCameraInterface;
...
public class CameraManager {
    ...
    public synchronized void startPreview() {
        Log.d(TAG, "startPreview() previewing = " + previewing);
        Camera theCamera = camera;
    ...
    public synchronized void stopPreview() {
        Log.d(TAG, "stopPreview() previewing = " + previewing);
